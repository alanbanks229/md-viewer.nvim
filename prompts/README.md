...
| f8 | [Stage 6 — WezTerm](drag_highlight_stage_6_wezterm_probe.md) | Support WezTerm on **both** `20240203` stable and current builds: re-probe, work around the per-cell `X`/`Y` defect if it is confirmed, and select the path automatically | Fable 5 / **Opus 5** | not started | — |
