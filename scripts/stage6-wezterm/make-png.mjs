...
//
//   node make-png.mjs <width> <height> <r> <g> <b> <a> <path>
//
...
const [width, height, r, g, b, a, out] = process.argv.slice(2);
if (!out) {
  console.error("usage: make-png.mjs <width> <height> <r> <g> <b> <a> <path>");
  process.exit(2);
}
const png = buildOverlaySheetPng(Number(width), Number(height), {
  r: Number(r),
  g: Number(g),
  b: Number(b),
  a: Number(a),
